...
addpath utils
%%  name and paths of the data files for right leg
% eNames={'green-iCub-Insitu-Datasets/2017_08_29_2';
%     'icub-insitu-ft-analysis-big-datasets/2016_05_09/darmstadt';
%     'icub-insitu-ft-analysis-big-datasets/2016_05_19/blackBothLegs';
%     'icub-insitu-ft-analysis-big-datasets/2018_09_07/2018_09_07_Grid';
%     'icub-insitu-ft-analysis-big-datasets/2018_09_07/2018_09_07_Grid_3';
...
eNames={
    ...
    'icub-insitu-ft-analysis-big-datasets/2016_05_19/blackBothLegs';
    'icub-insitu-ft-analysis-big-datasets/2018_09_07/2018_09_07_Grid';
    %     'icub-insitu-ft-analysis-big-datasets/2018_09_07/2018_09_07_Grid_2';
    'icub-insitu-ft-analysis-big-datasets/2018_09_07/2018_09_07_Grid_3';
...
plotOptions.ellipsoid=false; % plot ellipsoids and forces in force space
plotOptions.sVSe3D=false; %plot forces in force space
plotOptions.sVSe=false;%  plot to compare with estimated forces
plotOptions.norm=false;%  plot norm over time
...
for n=1:length(eNames)
    ...
    for ftIdx =1:length(sensorsToAnalize)
        ...
        fittedEllipsoid_im.(ft) = ellipsoidfit_smart(dataset.ftData.(ft)(:,1:3),dataset.estimatedFtData.(ft)(:,1:3));
        ...
        %fittedEllipsoid_noGravity.(ft) = ellipsoidfit_leastsquares(dataset.filteredFtData.(ft)(:,1),dataset.filteredFtData.(ft)(:,2),dataset.filteredFtData.(ft)(:,3));
        fittedEllipsoid_noGravity.(ft) = ellipsoidfit_leastsquares(dataset.ftData.(ft)(:,1),dataset.ftData.(ft)(:,2),dataset.ftData.(ft)(:,3));
    ...
    if(scriptOptions.printPlots)
        ...
        if (plotOptions.modelVSnoModel)
            for ftIdx =1:length(sensorsToAnalize)
                ...
                legend('withReference','noReference','Location','west');
                title(strcat({'Wrench space '},escapeUnderscores(ft), ' ',names(n)));
                xlabel('F_{x}');
                ylabel('F_{y}');
                zlabel('F_{z}');
...
% [error.left_leg*9.81,stdMasses.left_leg']
%
% [error_noGravity.left_leg*9.81,stdMassesNoG.left_leg']

[error.(ft)*9.81,stdMasses.(ft)',stdMassesNoG.(ft)']
